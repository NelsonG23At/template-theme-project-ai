...
Defines the centralized brand theming system that drives both Tailwind CSS and Ant Design through a single source of truth (`palette.ts`). Replacing the palette file reconfigures the entire application appearance instantly.
