...
Defines the role-based permission system: a static typed permission matrix, a Zustand session store `can()` gate, a `<PermissionGate>` component for conditional rendering, and a role-switcher UI for development/demo purposes.
