...
Defines the user edit page (`/users/:id/edit`) where authorized users can update editable user fields with Zod-validated React Hook Form inputs, optimistic React Query cache updates, and automatic redirect on success.
