...
Defines the user list page (`/users`) that displays all users fetched from the JSONPlaceholder API in a paginated, searchable, sortable Ant Design table with permission-gated row actions.
